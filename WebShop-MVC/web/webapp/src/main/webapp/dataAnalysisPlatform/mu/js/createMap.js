...
function initCreateMap(){
    ...
    map = new AMap.Map('chart_map', {
        zoom:13,//级别
        center: [104.072116,30.663465],//中心点坐标
        viewMode:'3D',// 地图模式
        mapStyle: 'amap://styles/7fabb672a7804f19625627b60048a919', //设置地图的显示样式
    });
}
//卫星地图的点击事件
...
function addPoints(data){
    ...
    console.log("总共:"+data['list_size']);
    $("#list_size").text("法拍房"+data['list_size']+"套")
    var markers2=[];
